...
export function renderPreamble(options?: PreambleOptions): string {
  ...
  return options.interactive
    ? 'You are OpenCLI, an interactive CLI agent specializing in software engineering tasks. Your primary goal is to help users safely and effectively.'
    : 'You are OpenCLI, an autonomous CLI agent specializing in software engineering tasks. Your primary goal is to help users safely and effectively.';
}
