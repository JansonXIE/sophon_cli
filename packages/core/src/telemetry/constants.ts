...
export const SERVICE_DESCRIPTION =
  'OpenCLI is an open-source AI agent that brings the power of AI directly into your terminal. It is designed to be a terminal-first, extensible, and powerful tool for developers, engineers, SREs, and beyond.';
